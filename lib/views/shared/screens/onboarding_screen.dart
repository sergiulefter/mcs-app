  ...
  List<OnboardingSlide> get _slides {
    ...
    return [
      OnboardingSlide(
        ...
        badgeTitle: 'onboarding.slide1_badge_title'.tr(),
        badgeSubtitle: 'onboarding.slide1_badge_subtitle'.tr(),
        badgeColor: primary,
        accentColor: primary,
      ),
      OnboardingSlide(
        ...
        badgeTitle: 'onboarding.slide2_badge_title'.tr(),
        badgeSubtitle: 'onboarding.slide2_badge_subtitle'.tr(),
      ...
      OnboardingSlide(
        ...
        badgeTitle: 'onboarding.slide3_badge_title'.tr(),
        badgeSubtitle: 'onboarding.slide3_badge_subtitle'.tr(),
